...
export default function Modal({ modalHeader, children, yesClickEvent, noClickEvent }) {
  return (
    <>
      <div className="flex absolute top-0 left-0 right-0 bottom-0 bg-neutral-600/55 backdrop-blur-sm justify-center items-center z-[100] px-8">
        <div className="max-w-[560px] w-full bg-white px-8 py-14 shadow-lg">
